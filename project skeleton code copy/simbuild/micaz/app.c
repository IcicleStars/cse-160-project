...
enum NeighborDiscoveryP____nesc_unnamed4346 {
#line 65
...
enum LinkStateP____nesc_unnamed4356 {
#line 213
...
enum /*LinkLayerC.Sender.SimpleSendP*/SimpleSendP__0____nesc_unnamed4360 {
#line 79
  ...
  if (neighbor_i == 10) {
      for (i = 0; i < 10; i++) {
          if (! NeighborDiscoveryP__neighbor_table[sim_node()][i].is_active) {
              ...
              sim_log_debug(139U, NEIGHBOR_CHANNEL, "NeighborDiscoveryP: Added new neighbor %u\n", __nesc_ntoh_uint16(received_pack->src.nxdata));
              break;
            }
        }
    }
...
#line 87
  ...
  if (__nesc_ntoh_uint16(msg->dest.nxdata) == TOS_NODE_ID) {
      sim_log_debug(185U, FLOODING_CHANNEL, "Packet reached destination. Processing ping from %hu\n", __nesc_ntoh_uint16(fh->source.nxdata));
...
#line 368
            if (new_fd > 0) {
                ...
                TransportP__sockets[sim_node()][new_index].nextExpected = __nesc_ntoh_uint8(t_hdr->seq_num.nxdata) + 1;
      ...
      case SYN_SENT: 
        if (__nesc_ntoh_uint8(t_hdr->flags.nxdata) == (TCP_SYN | TCP_ACK)) {
            s->state = ESTABLISHED;
            s->nextExpected = __nesc_ntoh_uint8(t_hdr->seq_num.nxdata) + 1;
            s->lastAck = __nesc_ntoh_uint8(t_hdr->ack_num.nxdata);
      ...
      case ESTABLISHED: 
        if (__nesc_ntoh_uint8(t_hdr->flags.nxdata) & TCP_ACK) {
            ...
            if (__nesc_ntoh_uint8(t_hdr->ack_num.nxdata) > s->lastAck) {
                s->lastAck = __nesc_ntoh_uint8(t_hdr->ack_num.nxdata);
              }
          }


      if (!(__nesc_ntoh_uint8(t_hdr->flags.nxdata) & TCP_SYN) && !(__nesc_ntoh_uint8(t_hdr->flags.nxdata) & TCP_FIN)) {
      ...
      case FIN_WAIT_2: 
        if (__nesc_ntoh_uint8(t_hdr->flags.nxdata) & TCP_FIN) {
            sim_log_debug(218U, TRANSPORT_CHANNEL, "\n");
            s->state = CLOSED;
            s->nextExpected = __nesc_ntoh_uint8(t_hdr->seq_num.nxdata) + 1;
            TransportP__send_tcp_packet(index, TCP_ACK, (void *)0, 0);
      ...
      case LAST_ACK: 
        if (__nesc_ntoh_uint8(t_hdr->flags.nxdata) & TCP_ACK) {
            sim_log_debug(219U, TRANSPORT_CHANNEL, "\n");
            s->state = CLOSED;
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * IPP__Receive__receive(uint8_t arg_0x7ffffa2de6e0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7ffffa2de6e0) {
#line 78
    case PROTOCOL_PING:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = IPP__Receive__default__receive(arg_0x7ffffa2de6e0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 41
  ...
  if (__nesc_ntoh_uint16(msg->dest.nxdata) == TOS_NODE_ID) {
      ...
      sim_log_debug(207U, ROUTING_CHANNEL, "IPP: Packet received for me at Node %d from Node %d\n", TOS_NODE_ID, src);
...
#line 55
          ...
          sim_log_debug(208U, ROUTING_CHANNEL, "IPP: Forwarding packet at Node %d from Node %d to Node %d via next hop %d\n", TOS_NODE_ID, src, __nesc_ntoh_uint16(msg->dest.nxdata), next_hop);
...
{
  if (err == SUCCESS) {
      sim_log_debug(188U, GENERAL_CHANNEL, "Linklayer AM started\n");
    }
  else 
#line 42
    {
      sim_log_debug(189U, GENERAL_CHANNEL, "Linklayer AM not started\n");
    }
}
...
{
  if (err == SUCCESS) {
      sim_log_debug(190U, GENERAL_CHANNEL, "Linklayer AM stopped\n");
    }
  else 
#line 50
    {
      sim_log_debug(191U, GENERAL_CHANNEL, "Linklayer AM not stopped");
    }
}
...
#line 248
{
  if (Node__client_fd[sim_node()] != 0) {
      sim_log_debug(115U, TRANSPORT_CHANNEL, "Node (Transport): Closing client socket (FD %u)\n", Node__client_fd[sim_node()]);
...
#line 255
        {
          sim_log_debug(116U, TRANSPORT_CHANNEL, "Node (Transport): FAILED to close socket\n");
        }
    }
}
...
#line 217
{
  ...
  if (Node__Transport__bind(Node__client_fd[sim_node()], &my_addr) != SUCCESS) {
      sim_log_debug(113U, TRANSPORT_CHANNEL, "Node (Transport): FAILED to bind client socket\n");
      return;
    }


  if (Node__Transport__connect(Node__client_fd[sim_node()], &dest_addr) != SUCCESS) {
      sim_log_debug(114U, TRANSPORT_CHANNEL, "Node (Transport): FAILED to start connect\n");
    }
}
...
#line 335
{
  ...
  sim_log_debug(140U, GENERAL_CHANNEL, "Neighbor Table\n");
  for (i = 0; i < 10; i++) {
      if (NeighborDiscoveryP__neighbor_table[sim_node()][i].is_active) {
          sim_log_debug(141U, GENERAL_CHANNEL, "Neighbor %u: ID=%u\n", i, NeighborDiscoveryP__neighbor_table[sim_node()][i].node_id);
        }
    }
}
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(117U, COMMAND_CHANNEL, "A Command has been Issued.\n");
      ...
      switch (commandID) {
          ...
          case CMD_PING: 
            sim_log_debug(118U, COMMAND_CHANNEL, "Command Type: Ping\n");
          CommandHandlerP__CommandHandler__ping(buff[0], &buff[1]);
          break;

          case CMD_NEIGHBOR_DUMP: 
            sim_log_debug(119U, COMMAND_CHANNEL, "Command Type: Neighbor Dump\n");
          CommandHandlerP__CommandHandler__printNeighbors();
          break;

          case CMD_LINKSTATE_DUMP: 
            sim_log_debug(120U, COMMAND_CHANNEL, "Command Type: Link State Dump\n");
          CommandHandlerP__CommandHandler__printLinkState();
          break;

          case CMD_ROUTETABLE_DUMP: 
            sim_log_debug(121U, COMMAND_CHANNEL, "Command Type: Route Table Dump\n");
...
#line 76
              sim_log_debug(122U, COMMAND_CHANNEL, "Command Type: Client\n");
...
#line 84
              sim_log_debug(123U, COMMAND_CHANNEL, "Command Type: Server\n");
...
#line 94
              sim_log_debug(124U, COMMAND_CHANNEL, "Command Type: Client Close\n");
          ...
          default: 
            sim_log_debug(125U, COMMAND_CHANNEL, "CMD_ERROR: \"%d\" does not match any known commands.\n", __nesc_ntoh_uint8(msg->id.nxdata));
          break;
        }
      CommandHandlerP__Pool__put(raw_msg);
    }
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7ffffa48e2a0, message_t * msg, error_t error){
#line 100
  switch (arg_0x7ffffa48e2a0) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7ffffa48e2a0, msg, error);
#line 100
      break;
#line 100
    }
...
#line 49
{
  ...
  sim_log_debug(184U, FLOODING_CHANNEL, "Node %hu is starting flood\n", TOS_NODE_ID);
...
#line 13
  struct __nesc_unnamed4310 *__nesc_result;
#line 13
...
#line 78
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7ffffa48c4d0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7ffffa48c4d0, addr, msg, len);
#line 80
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7ffffa547950){
#line 83
  switch (arg_0x7ffffa547950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7ffffa547950);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(168U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(167U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(164U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(165U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(157U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(147U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(154U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(159U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 292
  sim_log_debug(180U, ROUTING_CHANNEL, "LinkState: Initializing Link State Routing \n");
  for (i = 0; i < 20; i++) {
...
#line 114
{
  ...
  if (!NeighborDiscoveryP__timersStarted[sim_node()]) {
      sim_log_debug(137U, NEIGHBOR_CHANNEL, "NeighborDiscovery: Starting timers for the first time.\n");
...
#line 32
{
  ...
  __nesc_hton_uint8(t_hdr->seq_num.nxdata, s->lastSent);
  __nesc_hton_uint8(t_hdr->ack_num.nxdata, s->nextExpected);
  __nesc_hton_uint8(t_hdr->window.nxdata, 0);
  ...
  if (flags & TCP_SYN) {
      sim_log_debug(209U, TRANSPORT_CHANNEL, "TransportP: SENDING SYN to %u\n", __nesc_ntoh_uint16(s->dest.addr.nxdata));
    }
  if (flags & TCP_FIN) {
      sim_log_debug(210U, TRANSPORT_CHANNEL, "TransportP: SENDING FIN to %u\n", __nesc_ntoh_uint16(s->dest.addr.nxdata));
    }

  sim_log_debug(211U, TRANSPORT_CHANNEL, "TransportP: Calling IP.send() to %u\n", __nesc_ntoh_uint16(s->dest.addr.nxdata));
  result = TransportP__IP__send(&TransportP__sendBuffer[sim_node()], __nesc_ntoh_uint16(s->dest.addr.nxdata));

  if (result != SUCCESS) {
      sim_log_debug(212U, TRANSPORT_CHANNEL, "TransportP: IP Send FAILED!!!\n");
    }
  else 
#line 65
    {
      sim_log_debug(213U, TRANSPORT_CHANNEL, "TransportP: IP SEND SUCCEEDED\n");
    }
...
#line 18
{
  ...
  sim_log_debug(206U, ROUTING_CHANNEL, "IPP: Sending packet at Node %d to Node %d via Next Hop %d\n", TOS_NODE_ID, dest, next_hop);
...
#line 285
  ...
  sim_log_debug(156U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(162U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 94
  sim_log_debug(177U, ROUTING_CHANNEL, "Node %hu Network Topology:\n", TOS_NODE_ID);
  for (i = 0; i < 20; i++) {
      sim_log_debug(178U, ROUTING_CHANNEL, "\nNode %2hu: ", i);
      for (j = 0; j < LinkStateP__network_topology[sim_node()][i].num_neighbors; j++) {
          sim_log_debug(179U, ROUTING_CHANNEL, " -> (N:%2hu, C:%hu)", LinkStateP__network_topology[sim_node()][i].links[j].neighbor, LinkStateP__network_topology[sim_node()][i].links[j].cost);
        }
    }
}
...
#line 79
  sim_log_debug(174U, ROUTING_CHANNEL, "Node %hu Routing Table (Reachable):\n", TOS_NODE_ID);
  sim_log_debug(175U, ROUTING_CHANNEL, " Dest | Next Hop | Cost\n");
  for (i = 0; i < 20; i++) {

      if (LinkStateP__routing_table[sim_node()][i].next_hop != AM_BROADCAST_ADDR && i != TOS_NODE_ID) {
          sim_log_debug(176U, ROUTING_CHANNEL, "   %2hhu |   %4hu | %3hhu\n", i, LinkStateP__routing_table[sim_node()][i].next_hop, LinkStateP__routing_table[sim_node()][i].cost);
        }
    }
}
...
#line 76
  sim_log_debug(130U, "QueueC", "head <-");
  for (i = /*CommandHandlerC.QueueC*/QueueC__0__head[sim_node()]; i < /*CommandHandlerC.QueueC*/QueueC__0__head[sim_node()] + /*CommandHandlerC.QueueC*/QueueC__0__size[sim_node()]; i++) {
      sim_log_debug_clear(131U, "QueueC", "[");
...
#line 81
          sim_log_debug_clear(132U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(133U, "QueueC", "] ");
    }
  sim_log_debug_clear(134U, "QueueC", "<- tail\n");
}
...
#line 101
      sim_log_debug(142U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              sim_log_debug(143U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(144U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__set[sim_node()]) {
          ...
          sim_log_debug(145U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(163U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(166U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(155U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
...
#line 109
      ...
      /*CommandHandlerC.PoolC.PoolP*/PoolP__0__free[sim_node()]++;
      sim_log_debug(129U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*CommandHandlerC.PoolC.PoolP*/PoolP__0__free[sim_node()]);
      return SUCCESS;
    }
}

# 103 "lib/modules/TransportP.nc"
static socket_t TransportP__Transport__socket(void )
#line 103
{
